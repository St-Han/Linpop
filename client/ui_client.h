...
public:
    ...
    void setupUi(QMainWindow *client)
    {
        ...
        lineEdit_loginName->setStyleSheet(QString::fromUtf8("border-radius:15px; padding:5px 10px; background-color:#F2FAFF"));
        ...
        lineEdit_password->setStyleSheet(QString::fromUtf8("border-radius:15px; padding:5px 10px;background-color:#F2FAFF"));
        ...
        label_2->setGeometry(QRect(320, 620, 71, 31));
